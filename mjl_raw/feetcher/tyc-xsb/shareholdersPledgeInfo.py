...
"""
@Time ： 2020/12/16 4:41 PM
@Auth ： Stone
@File ：shareholdersPledgeInfo.py
@IDE  ：PyCharm
"""

# SHAREHOLDERS_PLEDGE_INFO(1019,"shareholdersPledgeInfo"),   重要股东质押
...
class ShareholdersPledgeInfo(object):
    ...
    def __init__(self):
        ...
        self.post_data = {
                "trdDataApi": "SHAREHOLDERS_PLEDGE_INFO",
        ...
        if result_dict == '':
            ...
            for result in json.loads(result_dict):
                result_frame.append([
                    ...
                    self.deal_json('latestCount', result),
                    self.deal_json('updateTimeEastmoney', result),
                    ...
                    self.deal_json('lastAmount', result),
    ...
    def save_to_csv(self, opinion_frame):
        try:
            if opinion_frame is None:
                ...
                file_name = 'shareholdersPledgeInfo.csv'
...
if __name__ == '__main__':
    share_holders_pledgeInfo = ShareholdersPledgeInfo()
    share_holders_pledgeInfo.run_main()