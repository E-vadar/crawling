        ...
        if result_dict == '':
            ...
            for result in json.loads(result_dict):
                result_frame.append([
                    ...
                    self.deal_json('regNo', result),
                    self.deal_json('tmPic', result),
                    self.deal_json('searchType', result),
                    self.deal_json('connList', result),
                    self.deal_json('_type', result),
                    self.deal_json('tmClass', result),
                    self.deal_json('appDate', result),
                    self.deal_json('intCls', result),
                    self.deal_json('applicantCn', result),
                    self.deal_json('uni', result),
                    self.deal_json('tmName', result),
                    self.deal_json('tmFlow', result),
