...
"""
@Time ： 2020/12/16 3:23 PM
@Auth ： Stone
@File ：report_company_base.py
@IDE  ：PyCharm
"""

# report_company_base  企业信用报告（基础版）   1034
# REPORT_COMPANY_BASE(1034,"reportCompanyBase"),
...
class Report_Company_Base(object):
    ...
    def save_to_csv(self, opinion_frame):
        try:
            if opinion_frame is None:
                ...
                file_name = 'report_company_base.csv'
...
if __name__ == '__main__':
    report_company_base = Report_Company_Base()
    report_company_base.run_main()