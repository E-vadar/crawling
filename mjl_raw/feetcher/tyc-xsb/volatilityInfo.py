...
"""
@Time ： 2020/12/16 11:25 AM
@Auth ： Stone
@File ：volatilityInfo.py
@IDE  ：PyCharm
"""
    ...
    def parse_data(self, response, company_name, qyxx_id):
        ...
        if result_dict == '':
            ...
            result_frame.append([
                ...
                result_dict.get('stockname'),
                result_dict.get('tamount'),
                result_dict.get('tvalue'),
                result_dict.get('hexm_float_rate'),
                result_dict.get('fvaluep'),
                result_dict.get('stockType'),
                result_dict.get('pprice'),
                result_dict.get('topenprice'),
                result_dict.get('tvaluep'),
                result_dict.get('tlowprice'),
                result_dict.get('tchange'),
                result_dict.get('tminprice'),
                result_dict.get('tamounttotal'),
                result_dict.get('trange'),
                result_dict.get('timeshow'),
                result_dict.get('flowvalue'),
                result_dict.get('hexm_curPrice'),
                result_dict.get('thighprice'),
                result_dict.get('graphId'),
                result_dict.get('tmaxprice'),
                result_dict.get('hexm_float_price'),
                result_dict.get('stockcode'),
            ])
            return result_frame
