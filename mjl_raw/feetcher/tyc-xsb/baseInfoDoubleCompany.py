    ...
    def parse_data(self, response, company_name, qyxx_id):
        ...
        if result_dict == '':
            ...
            result_frame.append([
                ...
                self.deal_json('historyNames', result_dict),
                ...
                self.deal_json('industry', result_dict),
                ...
                self.deal_json('usedBondName', result_dict),
                ...
                self.deal_json('city', result_dict),
                self.deal_json('district', result_dict),
