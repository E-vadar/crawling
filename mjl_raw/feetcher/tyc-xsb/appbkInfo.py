        ...
        if result_dict == '':
            ...
            for result in json.loads(result_dict):
                result_frame.append([
                    ...
                    self.deal_json('brief', result),
                    self.deal_json('classes', result),
                    self.deal_json('icon', result),
                    self.deal_json('name', result),
                    self.deal_json('filterName', result),
...
if __name__ == '__main__':
    app_bk_info = AppbkInfo()
    app_bk_info.run_main()