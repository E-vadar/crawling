...
"""
@Time ： 2020/12/16 2:41 PM
@Auth ： Stone
@File ：landPublicity.py
@IDE  ：PyCharm
"""

# landPublicity 地块公示---949
# LAND_PUBLICITY(949,"landPublicity"),
        ...
        if result_dict == '':
            ...
            for result in json.loads(result_dict):
                result_frame.append([
                    ...
                    self.deal_json('publication_organize', result),
                    self.deal_json('land_usefulness', result),
                    self.deal_json('administrative_district', result),
                    self.deal_json('land_location', result),
                    self.deal_json('publication_date', result),
                    self.deal_json('land_area', result),
...
if __name__ == '__main__':
    land_publi_city = LandPublicity()
    land_publi_city.run_main()