...
"""
@Time ： 2020/12/16 3:08 PM
@Auth ： Stone
@File ：privateFund.py
@IDE  ：PyCharm
"""

# privateFund---私募基金---954
# PRIVATE_FUND(954,"privateFund"),
        ...
        if result_dict == '':
            ...
            for result in json.loads(result_dict):
                result_frame.append([
                    ...
                    self.deal_json('reg_no', result),
                    self.deal_json('human_graph_id', result),
                    self.deal_json('org_type', result),
                    self.deal_json('company_graph_id', result),
                    self.deal_json('boss_name', result),
                    self.deal_json('manager_name', result),
                    self.deal_json('est_date', result),
