...
"""
@Time ： 2020/12/16 2:44 PM
@Auth ： Stone
@File ：landPublicity_detail.py
@IDE  ：PyCharm
"""

#landPublicity_detail  地块公示详情---950
# LAND_PUBLICITY_DETAIL(950,"landPublicityDetail"),
...
class LandPublicity_Detail(object):
    ...
    def __init__(self):
        ...
        self.post_data = {
                "trdDataApi": "LAND_PUBLICITY_DETAIL",
    ...
    def parse_data(self, response, company_name, qyxx_id):
        ...
        if result_dict == '':
            ...
            result_frame.append([
                ...
                result_dict.get('landUser_clean'),   # 列表
                result_dict.get('publication_organize'),
                result_dict.get('contact_person'),
                result_dict.get('land_location'),
                result_dict.get('land_area'),
                result_dict.get('remark'),
                result_dict.get('public_announcement_period'),
                result_dict.get('land_num'),
                result_dict.get('project_name'),
                result_dict.get('contact_number'),
                result_dict.get('electronic_mail'),
                result_dict.get('organize_location'),
                result_dict.get('land_usefulness'),
                result_dict.get('feedback_method'),
                result_dict.get('publication_date'),
                result_dict.get('contact_organize'),
                result_dict.get('postal_code'),
    ...
    def save_to_csv(self, opinion_frame):
        try:
            if opinion_frame is None:
                ...
                file_name = 'landPublicity_detail.csv'
...
if __name__ == '__main__':
    landPublicity_detail = LandPublicity_Detail()
    landPublicity_detail.run_main()