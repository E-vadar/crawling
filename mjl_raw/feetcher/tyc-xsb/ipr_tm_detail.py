...
"""
@Time ： 2020/12/16 4:36 PM
@Auth ： Stone
@File ：ipr_tm_detail.py
@IDE  ：PyCharm
"""

# 商标信息详情     ipr_tm_detail    1051     字段未解析
...
if __name__ == '__main__':
    ipr_tm_detail = Ipr_Tm_Detail()
    ipr_tm_detail.run_main()