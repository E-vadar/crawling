...
"""
@Time ： 2020/12/16 6:03 PM
@Auth ： Stone
@File ：punishmenthistoryInfo.py
@IDE  ：PyCharm
"""

# PUNISHMENTHISTORY_INFO(870,"punishmenthistoryInfo"),  历史行政处罚-工商局
...
class PunishmentHistoryInfo(object):
    ...
    def __init__(self):
        ...
        self.post_data = {
                "trdDataApi": "PUNISHMENTHISTORY_INFO",
    ...
    def save_to_csv(self, opinion_frame):
        try:
            if opinion_frame is None:
                ...
                file_name = 'punishmenthistoryInfo.csv'
...
if __name__ == '__main__':
    punishment_history_info = PunishmentHistoryInfo()
    punishment_history_info.run_main()