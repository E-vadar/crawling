...
class Supply_Info(object):
    ...
    def get_response(self, company_name, qyxx_id=None, year=None, pageNum = 1):
        self.post_data['trdDataRequest']['name'] = "四川康能电气股份有限公司"
        self.post_data['trdDataRequest']['pageNum'] = pageNum
        self.post_data['trdDataRequest']['year'] = year
        self.post_data['companyName'] = "四川康能电气股份有限公司"
    ...
    def run_main(self):
        ...
        for com in com_list[7352:]: # 745+16(761+1812)=2573+1863=4436+569+27+509=5541+1117=6658+12+3
            # 根据公司进行获取基本信息6637+715
