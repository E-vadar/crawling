...
"""
@Time ： 2020/12/16 4:00 PM
@Auth ： Stone
@File ：ipr_tm_search.py
@IDE  ：PyCharm
"""

# 商标信息垂搜   ipr_tm_search   1061
# IPR_TM_SEARCH(1061, "iprTmSearch"),
...
if __name__ == '__main__':
    ipr_tm_search = Ipr_Tm_Search()
    ipr_tm_search.run_main()