...
"""
@Time ： 2020/12/19 5:50 PM
@Auth ： Stone
@File ：zhixingInfo.py
@IDE  ：PyCharm
"""

# ZHIXINNG_INFO(839,"zhixingInfo"),  被执行人
...
if __name__ == '__main__':
    zhixing_info = ZhixingInfo()
    zhixing_info.run_main()