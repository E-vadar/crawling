...
"""
@Time ： 2020/12/19 5:55 PM
@Auth ： Stone
@File ：zhixinghistoryInfo.py
@IDE  ：PyCharm
"""

# ZHIXINGHISTORY_INFO(871,"zhixinghistoryInfo")   历史被执行人
...
class DhixingHistoryInfo(object):
    ...
    def __init__(self):
        ...
        self.post_data = {
                "trdDataApi": "ZHIXINGHISTORY_INFO",
        ...
        if result_dict == '':
            ...
            for result in json.loads(result_dict):
                result_frame.append([
                    ...
                    self.deal_json('pname', result),
                    self.deal_json('partyCardNum', result),
                    self.deal_json('caseCode', result),
                    self.deal_json('caseCreateTime', result),
                    self.deal_json('execMoney', result),
...
if __name__ == '__main__':
    zhixing_history_info = DhixingHistoryInfo()
    zhixing_history_info.run_main()