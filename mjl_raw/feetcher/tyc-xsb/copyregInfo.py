        ...
        if result_dict == '':
            ...
            for result in json.loads(result_dict):
                result_frame.append([
                    ...
                    self.deal_json('regtime', result),
                    self.deal_json('connList', result),
                    self.deal_json('searchType', result),
                    self.deal_json('_type', result),
                    self.deal_json('simplename', result),
                    self.deal_json('catnum', result),
                    self.deal_json('version', result),
                    self.deal_json('uni', result),
                    self.deal_json('publishtime', result),
                    self.deal_json('eventTime', result),
                    self.deal_json('authorNationality', result),
                    self.deal_json('regnum', result),
                    self.deal_json('id', result),
                    self.deal_json('fullname', result),
...
if __name__ == '__main__':
    copyreg_info = CopyRegInfo()
    copyreg_info.run_main()