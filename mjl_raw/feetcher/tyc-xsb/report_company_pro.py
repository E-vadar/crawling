...
"""
@Time ： 2020/12/16 3:21 PM
@Auth ： Stone
@File ：report_company_pro.py
@IDE  ：PyCharm
"""

# report_company_pro  企业信用报告（专业版）   1035
...
class Report_Company_Pro(object):
    ...
    def save_to_csv(self, opinion_frame):
        try:
            if opinion_frame is None:
                ...
                file_name = 'report_company_pro.csv'
...
if __name__ == '__main__':
    report_company_pro = Report_Company_Pro()
    report_company_pro.run_main()