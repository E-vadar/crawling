...
"""
@Time ： 2020/12/16 11:48 AM
@Auth ： Stone
@File ：descriptionInfo.py
@IDE  ：PyCharm
"""

# descriptionInfo  企业人员简介---448
# 需要公司名称和人员姓名一起查询
    ...
    def parse_data(self, response, company_name, qyxx_id):
        ...
        if result_dict == '':
            ...
            result_frame.append([
                ...
                result_dict.get('weibo'),
                result_dict.get('headUrl'),
