        ...
        if result_dict == '':
            ...
            for result in json.loads(result_dict):
                ...
                result_frame.append([
                    ...
                    self.deal_json('docid', result),
                    self.deal_json('rtm', result),
                    self.deal_json('title', result),
                    self.deal_json('uri', result),
                    self.deal_list(tag_list),
