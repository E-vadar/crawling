...
"""
@Time ： 2020/12/20 9:11 PM
@Auth ： Stone
@File ：humanRiskInfo.py
@IDE  ：PyCharm
"""
...
if __name__ == '__main__':
    human_risk_info = HumanRiskInfo()
    human_risk_info.run_main()