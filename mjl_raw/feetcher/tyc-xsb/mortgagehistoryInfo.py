...
"""
@Time ： 2020/12/16 5:16 PM
@Auth ： Stone
@File ：mortgagehistoryInfo.py
@IDE  ：PyCharm
"""

# MORTGAGEHISTORY_INFO(866,"mortgagehistoryInfo"),   历史动产抵押
...
class MortgageHistoryInfo(object):
    ...
    def __init__(self):
        ...
        self.post_data = {
                "trdDataApi": "MORTGAGEHISTORY_INFO",
        ...
        if result_dict == '':
            ...
            for result in json.loads(result_dict):
                ...
                result_frame.append([
                    ...
                    self.deal_json('amount', base_info),  # 只解析baseInfo字段数据
    ...
    def save_to_csv(self, opinion_frame):
        try:
            if opinion_frame is None:
                ...
                file_name = 'mortgagehistoryInfo.csv'
...
if __name__ == '__main__':
    mortgage_history_info = MortgageHistoryInfo()
    mortgage_history_info.run_main()