...
"""
@Time ： 2020/12/16 3:05 PM
@Auth ： Stone
@File ：investEvent.py
@IDE  ：PyCharm
"""

# 投资动态---investEvent---799
# INVEST_EVENT(799,"investEvent"),
        ...
        if result_dict == '':
            ...
            for result in json.loads(result_dict):
                result_frame.append([
                    ...
                    self.deal_json('product', result),
                    self.deal_json('logo', result),
                    self.deal_json('round', result),
                    self.deal_json('invest_date', result),
                    self.deal_json('news_url', result),
                    self.deal_json('product_id', result),
                    self.deal_json('news_title', result),
