...
"""
@Time ： 2020/12/16 4:53 PM
@Auth ： Stone
@File ：shareholder_detail.py
@IDE  ：PyCharm
"""

# shareholder_detail  重要股东质押详情   1020
...
class ShareholderDetail(object):
    ...
    def save_to_csv(self, opinion_frame):
        try:
            if opinion_frame is None:
                ...
                file_name = 'shareholder_detail.csv'
...
if __name__ == '__main__':
    shareholder_detail = ShareholderDetail()
    shareholder_detail.run_main()