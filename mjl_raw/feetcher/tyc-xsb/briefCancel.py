    ...
    def parse_data(self, response, company_name, qyxx_id):
        ...
        if result_dict == '':
            ...
            result_frame.append([
                ...
                result_dict.get('result').get('brief_cancel_result'),
                result_dict.get('announcement').get('reg_authority'),
                result_dict.get('announcement').get('company_name'),
                result_dict.get('announcement').get('credit_code'),
                result_dict.get('announcement').get('id'),
                result_dict.get('announcement').get('announcement_term'),
                result_dict.get('announcement').get('announcement_end_date'),
                result_dict.get('announcement').get('ossPath'),
                result_dict.get('objection').get('objection_content'),
                result_dict.get('objection').get('objection_date'),
                result_dict.get('objection').get('objection_apply_person'),
...
if __name__ == '__main__':
    brief_cancel = BriefCancel()
    brief_cancel.run_main()