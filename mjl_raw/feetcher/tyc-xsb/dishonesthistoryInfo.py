...
"""
@Time ： 2020/12/19 6:05 PM
@Auth ： Stone
@File ：dishonesthistoryInfo.py
@IDE  ：PyCharm
"""

## DISHONESTHISTORY_INFO(872,"dishonesthistoryInfo"), 历史失信人信息
...
class DishonestHistoryInfo(object):
    ...
    def __init__(self):
        ...
        self.post_data = {
                "trdDataApi": "DISHONESTHISTORY_INFO",
...
if __name__ == '__main__':
    dishonest_historyu_info = DishonestHistoryInfo()
    dishonest_historyu_info.run_main()