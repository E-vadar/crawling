...
"""
@Time ： 2020/12/16 3:49 PM
@Auth ： Stone
@File ：ipr_patents_search.py
@IDE  ：PyCharm
"""

# ipr_patents_search   专业信息垂搜    1062
# IPR_PATENTS_SEARCH(1062,"iprPatentsSearch"),
...
class Ipr_Patents_Search(object):
    ...
    def save_to_csv(self, opinion_frame):
        try:
            if opinion_frame is None:
                ...
                file_name = 'ipr_patents_search.csv'
...
if __name__ == '__main__':
    ipr_patents_search = Ipr_Patents_Search()
    ipr_patents_search.run_main()