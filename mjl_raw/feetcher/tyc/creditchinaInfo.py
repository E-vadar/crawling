...
"""
@Time ： 2020/12/16 6:07 PM
@Auth ： Stone
@File ：creditchinaInfo.py
@IDE  ：PyCharm
"""

# CREDITCHINA_INFO(852,"creditchinaInfo"),    行政处罚-其他来源
...
if __name__ == '__main__':
    credit_china_info = CreditChinaInfo()
    credit_china_info.run_main()
