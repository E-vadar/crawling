...
class MembersInfo(object):
    ...
    def parse_data(self, response, company_name, qyxx_id):
        ...
        if result_dict == '':
            ...
            pastLegalPersonList = result_dict.get('pastLegalPersonList')
            pastStafferList = result_dict.get('pastLegalPersonList')
            pastholderList = result_dict.get('pastholderList')
            result_frame.append([
                ...
                result_dict.get('historyNames'),
                # if name_list:
                #     '#'.join(result_dict.get('historyNameList'))
                # else:
                #     ''
                result_dict.get('regStatus'),
                result_dict.get('cancelDate'),
                result_dict.get('regCapital'),
                result_dict.get('staffNumRange'),
                result_dict.get('industry'),
                result_dict.get('bondNum'),
                result_dict.get('type'),
                result_dict.get('bondName'),
                result_dict.get('revokeDate'),
                result_dict.get('legalPersonName'),
                result_dict.get('revokeReason'),
