...
"""
@Time ： 2020/12/16 2:30 PM
@Auth ： Stone
@File ：companyholding.py
@IDE  ：PyCharm
"""

# 人员控股企业---1033    一个字典字段未解析
    ...
    def parse_data(self, response, company_name, qyxx_id):
        ...
        if result_dict == '':
            ...
            for result in json.loads(result_dict):
                ...
                # chainList = self.deal_list('chainList', result)
                # for data in chainList:
...
if __name__ == '__main__':
    company_holding = CompanyHolding()
    company_holding.run_main()