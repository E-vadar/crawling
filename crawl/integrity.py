    ...
    if state.get('data').get('successFlag') == True:
        try:
            ...
            myWriter.writerow([
                ...
                company_name,
                do_time,
                result.get("special_msg"),
                result.get("amac_last_updatetime"),
                result.get("graph_id"),
            ])
        except:
            print("fail!")
...
if __name__ == '__main__':
    ...
    data_list_dic = []
    with open('D:/qiyuanwork/pythonProject/parse/doc/csv_file_neeq/integrity.csv', 'w', encoding='utf-8', newline='') as myFile:
