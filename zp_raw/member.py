...
if __name__ == '__main__':
    ...
    data_list_dic = []
    with open('D:/qiyuanwork/pythonProject/parse/doc/csv_file_neeq/member.csv', 'w', encoding='utf-8', newline = '') as myFile:
